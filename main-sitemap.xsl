			...
			<head>
				<xsl:choose>
					<xsl:when test="kml:kml">
						<title>Locations Sitemap - Daria Gruszka &#8211; Psychoterapia CBT Wrocław</title>
					</xsl:when>
					<xsl:otherwise>
						<title>XML Sitemap - Daria Gruszka &#8211; Psychoterapia CBT Wrocław</title>
					</xsl:otherwise>
				</xsl:choose>
				...
				<xsl:choose>
					<xsl:when test="kml:kml">
						...
						<div id="content">
							...
							<p class="expl">
								<a href="https://pearcepcja.github.io/portfolio/sitemap_index.xml">&#8592; Sitemap Index</a>							</p>
